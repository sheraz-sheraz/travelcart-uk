...
TravelCart.uk is not the operating carrier and does not control flight operations, schedules, or cancellations...</p>
        ...
        <section>
          ...
          <ul className="list-disc pl-5">
            ...
            <li><strong>Payment Terms:</strong> Full payment is required at the time of booking unless you opt for our "Book Now, Pay Later" scheme.Book now pay later is available on case by case basis and does not
              apply to all bookings. Airline can withdraw a fare before any ticket is issued and we are not liable in this case.Third party payments are not allowed except in-person bookings.</li>
            <li><strong>Deposit:</strong> Paying a deposit to hold your flight only guarantees the seat, not the price. Full payment is needed for ticket issuance and if not ticketed the airline can change the price. Deposits are non-refundable in case of cancellation.</li>
            <li><strong>Book Now, Pay Later:</strong> This option allows a major part of your ticket as upfront payment and you get your ticket issued straight away with a time period to make remaining payment before your travel date.Failure to pay on time results in cancellation without refund.
              .</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5">
            ...
            <li><strong>Airline-Initiated Changes:</strong> Will be communicated as per the airline's policy.Schedule changes are common and we inform our customers as soon as we receive an update from the airline.In line with UK261 regulations, passengers may be entitled to re-routing, or refund of the unused airline fare.These rights apply to the airline portion only..</li>            
            <li><strong>Cancellations:</strong> Subject to airline policies + £175 Cancellation fee per ticket charged by travelcart.uk. Ticket maybe refundable/non-refundable depending on the airline's rules and regulations.Refunds are limited strictly to the amount refunded by the airline,TravelCart.uk cannot refund amounts not received from the airline.The TravelCart.uk booking and service fee is earned once a ticket is issued and non-refundable in all circumstances, including airline cancellation, schedule change, or passenger withdrawal.</li>
